        ...
        <footer className="bg-muted pt-10">
            <div className="container">
                <div className="grid grid-cols-1 gap-5 md:grid-cols-2 md:gap-x-20 md:gap-y-14 lg:grid-cols-[40%_30%_30%] lg:gap-16">
                    <div>
                        <div className="flex items-end gap-2">
                            ...
                            <Link href={"/"} className="font-bold font-display text-xl tracking-wide text-primary md:text-[22px] lg:text-[24px]">
                                ChetraCoffee
                            </Link>
                        </div>
                    ...
                    <div>
                        <h5 className="font-bold font-display text-xl tracking-wide text-primary md:text-[22px] lg:text-[24px] mb-4">
                            Quick Links
                        </h5>
                    ...
                    <div className="md:col-span-2 md:flex md:flex-col md:justify-center md:items-center lg:col-span-1 lg:flex-none lg:justify-start lg:items-start">
                        <h4 className="font-bold font-display text-xl tracking-wide text-primary md:text-[22px] lg:text-[24px] mb-4">Follow us on Socials</h4>
                        <div className="flex gap-x-3">
                            <Link 
                                href="/" 
                                className="block bg-primary text-custom-white p-2 rounded-lg hover:bg-green-600 transition-colors"
                            >
                ...
                <div className="mt-4 py-5 text-center">
                    <div className="h-[1.25px] rounded-full bg-gradient-to-r from-secondary via-primary to-secondary"></div>
