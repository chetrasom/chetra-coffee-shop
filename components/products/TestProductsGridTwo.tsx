...
const TestProductsGridTwo = ({ img }: { img: string }) => {
    return (
        // bg-[#f5d8b7]
            ...
            <Link href={`#`}>
                ...
                <div>
                    <div className="text-center space-y-2.5 md:pb-5">
                        ...
                        {/* text-[#f8e8d6] */}
                        {/* <Button className="bg-[#bd7a38] rounded-lg h-11 px-6 capitalize gap-x-1 font-poppins text-[#fcf3e8]">
                            Order Now <span className=" text-xl font-bold text-[#fcf3e8]">$15</span>
                        </Button> */}
                        <Button className="bg-[#bd7a38] rounded-lg h-11 capitalize gap-x-2 font-poppins text-[#fcf3e8]">
                            ...
                            <span className=" text-xl font-bold text-[#fcf3e8]">$15</span>
                        </Button>
                    </div>
                </div>
            </Link>
...
export default TestProductsGridTwo