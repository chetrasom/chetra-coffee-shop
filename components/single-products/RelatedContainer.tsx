                        ...
                        relatedProducts.map((product) => {
                            ...
                            return (
                                <SwiperSlide key={product.id}>
                                    <article className="relative border rounded-lg overflow-hidden group transform hover:shadow-xl transition-shadow duration-500">
                                        <Link href={`/products/${product.id}`}>
                                            {/* Image */}
                                            <div className="relative grid place-items-center place-content-center w-[15rem] h-[15rem] py-5 mx-auto">
                                                <div 
                                                    id="shape"
                                            ...
                                            <div>
                                                <div className="text-center space-y-2.5 pb-5">
                                                    ...
                                                    <Button className="h-11 px-2 md:px-4">
                                                        Order now: {dollarAmount}
                                                    </Button>
                                                </div>
                                            </div>
                                        </Link>
